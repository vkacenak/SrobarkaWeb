...
<body>
  <div class="photo-heading heading-aktivity bgNRCC">
    <div class="heading-wrapper">
      <h1 class="w700 ">Predmety</h1>
      <h6 class="w400"></h2>
    </div>
  </div>
  <div class="container">
    <div class="PredmetyBox">
      <div class="row">
      <div class="col-sm-4 predmet"><img src="img/predmety/SJL.png"><p class="p2 w700">Slovenský jazyk a literatúra<p></div>
      <div class="col-sm-4 predmet"><img src="img/predmety/MAT.png"><p class="p2 w700">Matematika<p></div>
      <div class="col-sm-4 predmet"><img src="img/predmety/ANJ.png"><p class="p2 w700">Anglický jazyk<p></div>
      </div>

      <div class="row">
      <div class="col-sm-4 predmet"><img src="img/predmety/FYZ.png"><p class="p2 w700">Fyzika<p></div>
      <div class="col-sm-4 predmet"><img src="img/predmety/CHEM.png"><p class="p2 w700">Chémia<p></div>
      <div class="col-sm-4 predmet"><img src="img/predmety/BIO.png"><p class="p2 w700">Biológia<p></div>
      </div>
      <div class="row">
      <div class="col-sm-4 predmet"><img src="img/predmety/FRJ.png"><p class="p2 w700">Francúzsky jazyk<p></div>
      <div class="col-sm-4 predmet"><img src="img/predmety/RUJ.png"><p class="p2 w700">Ruský jazyk<p></div>
      <div class="col-sm-4 predmet"><img src="img/predmety/NEM.png"><p class="p2 w700">Nemecký jazyk<p></div>
      </div>
      <div class="row">
      <div class="col-sm-4 predmet"><img src="img/predmety/INF.png"><p class="p2 w700">Informatika<p></div>
      <div class="col-sm-4 predmet"><img src="img/predmety/DEJ.png"><p class="p2 w700">Dejepis<p></div>
      <div class="col-sm-4 predmet"><img src="img/predmety/OBN.png"><p class="p2 w700">Občianska náuka<p></div>
      </div>
      <div class="row">
      <div class="col-sm-4 predmet"><img src="img/predmety/GEO.png"><p class="p2 w700">Geografia<p></div>
      <div class="col-sm-4 predmet"><img src="img/predmety/TV.png"><p class="p2 w700">Telesná výchova<p></div>
      <div class="col-sm-4 predmet"><img src="img/predmety/VYCH.png"><p class="p2 w700">Náboženstvo/Etická výchova<p></div>

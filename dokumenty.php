...
<body>
  <div class="photo-heading heading-dokumenty bgNRCC">
    <div class="heading-wrapper">
      <h1 class="w700 ">DOKUMENTY</h1>
      <h6 class="w400">Najdôležitejšie súbory na jednom mieste</h2>
    </div>
  </div>
<div class="container">
  <div class="document-list row ">
  <ul>
    <a><li> Správa o výchovno - vzdelávacej činnosti </li><a>
    <a><li> Sprava o výchovno-vzdelávacej činnosti, jej výsledkoch a podmienkach za školský rok 2008/2009 </li><a>
    <a><li>školský vzdelávací program, 2012-2013 </li><a>
    <a><li>Sprava o výchovno-vzdelávacej činnosti, jej výsledkoch a podmienkach za školský rok 2010/2011 </li><a>
    <a><li>Sprava o výchovno-vzdelávacej činnosti, jej výsledkoch a podmienkach za školský rok 2011/2012 </li><a>
    <a><li>Sprava o výchovno-vzdelávacej činnosti, jej výsledkoch a podmienkach za školský rok 2012/2013</li><a>
    <a><li>Sprava o výchovno-vzdelávacej činnosti, jej výsledkoch a podmienkach za školský rok 2013/2014 </li><a>
  </ul>
